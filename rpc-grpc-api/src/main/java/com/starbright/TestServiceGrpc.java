...
public final class TestServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.starbright.TestProto.TestRequest,
      com.starbright.TestProto.TestResponse> getTestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "test",
      requestType = com.starbright.TestProto.TestRequest.class,
      responseType = com.starbright.TestProto.TestResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.starbright.TestProto.TestRequest,
      com.starbright.TestProto.TestResponse> getTestMethod() {
    io.grpc.MethodDescriptor<com.starbright.TestProto.TestRequest, com.starbright.TestProto.TestResponse> getTestMethod;
    if ((getTestMethod = TestServiceGrpc.getTestMethod) == null) {
      synchronized (TestServiceGrpc.class) {
        if ((getTestMethod = TestServiceGrpc.getTestMethod) == null) {
          TestServiceGrpc.getTestMethod = getTestMethod =
              io.grpc.MethodDescriptor.<com.starbright.TestProto.TestRequest, com.starbright.TestProto.TestResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "test"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.starbright.TestProto.TestRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.starbright.TestProto.TestResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void test(com.starbright.TestProto.TestRequest request,
        io.grpc.stub.StreamObserver<com.starbright.TestProto.TestResponse> responseObserver) {
  ...
  public static final class TestServiceStub
    ...
    /**
     */
    public void test(com.starbright.TestProto.TestRequest request,
        io.grpc.stub.StreamObserver<com.starbright.TestProto.TestResponse> responseObserver) {
  ...
  public static final class TestServiceBlockingStub
    ...
    /**
     */
    public com.starbright.TestProto.TestResponse test(com.starbright.TestProto.TestRequest request) {
  ...
  public static final class TestServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.starbright.TestProto.TestResponse> test(
        com.starbright.TestProto.TestRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TEST:
          serviceImpl.test((com.starbright.TestProto.TestRequest) request,
              (io.grpc.stub.StreamObserver<com.starbright.TestProto.TestResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.starbright.TestProto.TestRequest,
              com.starbright.TestProto.TestResponse>(
  ...
  private static abstract class TestServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.starbright.TestProto.getDescriptor();
    }
